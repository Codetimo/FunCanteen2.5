...
<h2>超级管理员入口</h2>
		<div class="main_bar">
			<div id="login_form" class="login_form">
				<div class="title"></div>
				<form action="${pageContext.request.contextPath }/superlogin.action" method="post">
					<div id="form_widgt">
						<input type="text" name="supername" class="name" placeholder="请输入账号"><br>
						<input type="password" name="superpwd" class="pwd"  placeholder="请输入密码">
						<h4>${error}</h4>
						<br>
