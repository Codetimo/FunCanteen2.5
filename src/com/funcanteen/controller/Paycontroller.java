...
import web.AutoLoadServlet;

@Controller
public class Paycontroller {
	 
	    
	@RequestMapping(value="reallypay.action")
	public String reallyPay(Integer pic,Model model) {
		model.addAttribute("price", pic);
		return "pages/consume";
	}
	
	@RequestMapping(value="backpay.action")
	public String backPay() {
		return "pages/consumeUndo";
	}
	...
	@RequestMapping(value="filetransfer.action")
	public String filetransfer() {
		return "pages/file_transfer";
	}
	
	@RequestMapping(value="runout.action")
	...
	public void runout(HttpServletRequest req, HttpServletResponse resp )throws ServletException, IOException {
         resp.setContentType("text/html; charset="+ DemoBase.encoding);
//         AutoLoadServlet auto=new AutoLoadServlet();
//     	  auto.init();
		//前台页面传过来的
		...
		/***商户接入参数***/
		requestData.put("merId",  "777290058155173");    	          			  //商户号码，请改成自己申请的正式商户号或者open上注册得来的777测试商户号
		...
		requestData.put("frontUrl", "http://localhost:8080/FunCanteen/frontRcvResponse");
		...
		requestData.put("backUrl", "http://222.222.222.222:8080/FunCanteen/backRcvResponse");
